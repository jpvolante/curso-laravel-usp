...
return [
    ...
    /*
     * Shell commands that should be run after the export has finished whenclear
     * running `php artisan export`.
     *
     * You can skip these by adding a `--skip-{name}` flag to the command.
     */
    'after' => [
        # corrige caminho aplicando as configs do destino
        'replaceBase' =>'php artisan replaceBase',
